# Worksheet 
Excellent. You have worked through the steps in this computer tutorial on [downloading](01-data-prep.html) and [mapping](02-map-crime.html) crime data, you need to conduct the following analysis **as a group**:
...
- Maximum **4** maps, and, if using, a maximum of **2** photographs.
 Your file should be submitted anonymously by the allocated team leader by **noon on Monday 18 March**, using the Turnitin link on [Moodle]() *GEOG0014 Worksheet 4 London mapping*.
